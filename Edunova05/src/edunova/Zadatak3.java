...
public class Zadatak3 {
	...
	public static void main(String[] args) {
		int prviBroj = Integer.parseInt(JOptionPane.showInputDialog
				("Zadaj koliko brojeva želiš poredati po veličini padajućim slijedom"));
		int niz[] = new int[prviBroj];
		for(int i=0;i<prviBroj;i++) {
			niz[i] = Integer.parseInt(JOptionPane.showInputDialog("Zadaj broj"));
		}
		Arrays.sort(niz);
